let amigos = [];   //Se crea una variable llamada amigos que es un Array(lista) vacía.Este array se utilizá para almacenar los nombres de los amigoa que se agregan.
